...
**Format Conversion**:
```
Input:  acme.tg#customer-support:7
Output: 
  - Source: acme.tg:7
  - Filter: acme.tg:7:discord_channel_name=customer-support
```
...
**Problem**: `maia chat -b acme.tg -b acme` only processed the last argument
...
maia chat -b acme.tg acme --debug
...
maia chat -b acme.tg#specific-channel:7
